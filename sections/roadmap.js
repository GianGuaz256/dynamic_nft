...
const ROAD_MAP_DATA = {
  blockTitle: {
    title: 'The (hopefully not) Dynamic Roadmap',
    text: 'Ready to go on this journey with us?',
  },
  posts: [
    {
      date: '1 December 2021',
      title: 'Release of the first collection',
      text:
        'The first collection od Dynamic NFTs will be release and we will collect your thoughts 🎈',
    },
    {
      date: '1 February 2022',
      title: '1st real world Dynamic NFT collection',
      text:
        'We have something really cool in mind, dont miss out 🥚',
    },
    {
      date: '1 May 2022',
      title: '2nd real world collection & metaverse',
      text:
        'The further we go, the more surprises we will have for you 🔥',
    },
  ],
};
...
const styles = {
  section: {
    pb: ['63px', '75px', null, '90px', '110px', null, '140px'],
    pt: ['63px', '75px', null, '90px', '110px', null, '140px'],
    position: 'relative',
  },
  shapeLine: {
    width: '100%',
