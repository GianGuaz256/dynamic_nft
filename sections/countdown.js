...
const deadline = new Date(2021, 11, 1, 0, 0, 0);
const COUNTDOWN_DATA = {
  title: 'Save the date and be ready to mint the new Dynamic NFTs',
  text:
    'On the first of December dont miss it, the first collection of Dynamic NFT with 3333 new tokens will be released. Dont miss the chance to be part of the community and create your own story out of the box.',
  button: {
    link: '#',
    label: 'Buy Tokens',
  },
...
const styles = {
  section: {
    ...
    color: '#FFFFFF',
    pt: ['55px', '65px', null, '90px', '110px', null, '130px', '140px'],
